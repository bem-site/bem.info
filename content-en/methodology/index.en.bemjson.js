    ...
    content: [
        ...
        },
        {
            ...
            content: [
                ...
                {
                    block: 'promo-text',
                    content: 'Common terminology provides ability for developers to rapidly switch projects&nbsp;— everything is ?знакомо???.'
                }
            ]
        }
    ]
    ...
    content: [
        ...
        },
        {
            ...
            content: [
                ...
                {
                    block: 'promo-text',
                    content: 'Common rules help to automate process. Code may be partially (partually???) autogenerated.'
                }
            ]
        }
    ]
        ...
        },
        {
            ...
            content: [
                ...
                },
                {
                    ...
                    text: 'I choose BEM over other methodologies comes down to this: itʼs less confusing than the other methods (i.e. SMACSS) but still provides us the good architecture we want (i.e. OOCSS) and with a recognisable terminology.'
                },
                {
                    name: '???',
                    photo: '/promo-section__quote_default-photo.png',
                ...
                },
                {
                    name: 'Vadim Makeev',
                    photo: '/promo-section__quote_default-photo.png',
                    position: '??? Evangelist, Opera Software',
