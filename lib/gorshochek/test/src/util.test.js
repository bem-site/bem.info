...
describe('util', () => {
    ...
    describe('isPagePublished', () => {
        it('should treat pages without "published" field as published', () => {
            util.isPagePublished({}).should.be.true;
        });

        it('should return false for unpublished pages', () => {
            util.isPagePublished({published: false}).should.be.false;
        });
    });
