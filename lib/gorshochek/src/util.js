...
/**
 * Returns true when page should participate in build tasks.
 * `published` defaults to true during model normalization, but tasks may be
 * run against non-normalized pages in tests or custom pipelines.
 * @param {Object} page - model page object
 * @returns {Boolean}
 */
exports.isPagePublished = (page) => {
    return typeof page.published === 'undefined' ? true : !!page.published;
};
