...
(function() {
	...
	*/
	var objects_vanilla_default = (	/** @exports */ {
	...
	*/
	var functions_vanilla_default = (	/** @exports */ {
		isFunction(obj) {
	...
	*/
	...
	var i_bem__internal_vanilla_default = (	/** @exports */ {
	...
	var BemEntity = inherit(
		/** @lends BemEntity.prototype */
		{
			...
			toggleMod: function(modName, modVal1, modVal2, condition) {
				typeof modVal1 === "undefined" && (modVal1 = true);
		...
		/** @lends EventManager.prototype */
		{
			...
			un(e, fn, _fnCtx) {
				...
				if (argsLen) {
					const params = this._params;
					const event = this._eventBuilder(e, params);
					if (argsLen === 1) this._unbindByEvent(this._storage.get(event), event);
					else {
						const fnId = identify_vanilla_default(fn, _fnCtx);
			...
			getEventManager(ctx, bindCtx, bindScope) {
				...
				if (!ctxStorage) {
					...
					if (isBindToInstance) ctx._events().on({
						...
						params.bindToArbitraryDomElem && ctxStorage[storageKey] && ctxStorage[storageKey].un();
	...
	*/
	var EVENT_PREFIX = "__bem__", MOD_CHANGE_EVENT = "modchange", specialEvents = jquery_default.event.special, specialEventsStorage = {}, createSpecialEvent = function(event) {
		...
		const event = EVENT_PREFIX + params.bindEntityCls.getEntityName() + (typeof e === "object" ? e instanceof events_vanilla_default.Event ? e.type : i_bem__internal_vanilla_default.buildModPostfix(e.modName, e.modVal) : e);
	...
	*/
	function getJqueryCollection(html) {
		return jquery_default(typeof html === "string" ? jquery_default.parseHTML(html, null, true) : html);
	}
	/**
	...
	var BemDomEntity = inherit(
		/** @lends BemDomEntity.prototype */
		{
			...
			_extractModVal: function(modName) {
				...
				let matches;
				domNode && (matches = domNode.className.match(this.__self._buildModValRE(modName)));
